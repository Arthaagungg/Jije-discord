const config = {
    ...
    development: {
        ...
        guildId: '1354589321511960747',
    },
    commands: {
        prefix: 'jj', // For message commands, prefix is required. This can be changed by a database.
        message_commands: true, // If true, the bot will allow users to use message (or prefix) commands.
        application_commands: {
            chat_input: false, // If true, the bot will allow users to use chat input (or slash) commands.
    ...
    users: {
        ownerId: '771528467249365003', // The bot owner ID, which is you.
        developers: ['771528467249365003'] // The bot developers, remember to include your account ID with the other account IDs.
    },
